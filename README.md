...
### SSR rendering in Next.js 14

- SSR rendering in next.js with app router can be done with simple async/await, there is no need of useState/useEffect hooks.
- The data are rendered in the server(terminal) rather than in the browser.
